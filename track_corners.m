...
corners(:,:,1) = img_pts;
rgb_image = cell2mat(images(1));
gray_image = rgb_image(1:480,1:640);
pointTracker = vision.PointTracker;
initialize(pointTracker, img_pts, gray_image);

% Iterate through the rest of the images
for i = 2:size(images,1)
    %%%% CODE FOR TRACKING HERE %%%%
    rgb_image = cell2mat(images(i));
    newgray_image = rgb_image(1:480,1:640);
    keypts = step(pointTracker,newgray_image);
